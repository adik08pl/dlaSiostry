...
public class ForthActivity extends AppCompatActivity {
    ...
    private final com.example.dlasiostry.ForthActivity this2 = this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_forth);
        dodajDoListy("Małpa", "YƎꓘИOM");
        dodajDoListy("Słoń", "TИAHꟼƎ⅃Ǝ");
        dodajDoListy("Papuga", "TOЯAꟼ");
        dodajDoListy("Zebra", "ZEBᖉⱯ");
        dodajDoListy("Hipopotam", "OꟼꟼIH");
        dodajDoListy("Żyrafa", "ƎᖷᖷAЯIӘ");
        dodajDoListy("Mysz", "ƎƧUOM");
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                button4.animate().rotationY(button4.getRotationY() - 360);
