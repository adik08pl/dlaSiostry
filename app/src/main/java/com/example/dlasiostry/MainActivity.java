...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean czyKlikniete1=true,czyKlikniete2=true,czyKlikniete3=true,czyKlikniete4=true,czyKlikniete5=true,czyKlikniete6=true,czyKlikniete7=true;
    private List<String> listaEnglish = new ArrayList<>();
    private List<String> listaPolish = new ArrayList<>();
    private MainActivity this2=this;
    @Override
